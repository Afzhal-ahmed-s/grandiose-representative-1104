...
public class AdminController {
	...
	@PostMapping("/signUp")
	public ResponseEntity<Admin> signUpAdmin(@RequestBody Admin admin) throws AdminException{
	...
	public ResponseEntity<Admin> updateAdmin(@RequestBody Admin admin, @PathParam(value = "uuidKey") String key) throws AdminException{
